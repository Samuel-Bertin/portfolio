public class ModeleMastermind {
     ...
     */
    public ModeleMastermind(int v, int t) {
    	this.nb_valeurs = v;
    	this.taille = t;
    ...
    /**
     * genere aleatoirement une combinaison de this.taille this.taille dont les valeurs
     * sont comprises entre 0 et nbValeurs-1
     */
    public void genererCombinaison() {
        for (int i = 0; i < this.taille; i++) {
            this.combinaison[i] = (int) (this.nb_valeurs * Math.random());
        }
    }
