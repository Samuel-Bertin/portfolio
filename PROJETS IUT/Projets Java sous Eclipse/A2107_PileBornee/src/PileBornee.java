public class PileBornee<E> {
    ...
    public void push(E valeur) throws FullStackException {
    	if (this.isFull()) {
    		throw new FullStackException("Pile déja pleine");
    	}
    ...
    public void pop() throws EmptyStackException {
    	if (this.isEmpty()) {
    		throw new EmptyStackException("On ne peut pas dépilier une pile vide");
    	}
    ...
    private class Cellule {
        ...
        public Cellule(E valeur, Cellule suivant) {
            this.valeur = valeur;
