...
public class CopieDeRechercheSequentielle {
    ...
    public static void main(String[] args) {
        ...
        TableauArrayList<Integer> tab = new TableauArrayList<Integer>(NB);
